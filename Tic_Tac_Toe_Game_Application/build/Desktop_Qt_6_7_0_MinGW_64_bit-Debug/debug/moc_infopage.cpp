...
constexpr auto qt_meta_stringdata_CLASSInfoPageENDCLASS = QtMocHelpers::stringData(
    "InfoPage",
    "homeRequested",
    "",
    "handleHome"
...
void InfoPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->handleHome(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (InfoPage::*)();
            if (_t _q_method = &InfoPage::homeRequested; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
